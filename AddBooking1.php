...
<?php
  if(isset($_POST['AddBooking'])){
     ...
     if($conn->connect_error)
          ...
          {
             $query="select count(passenger_name) from booking having count(passenger_name) > 5";
            ...
            $conn->close();
               ...
               echo '<script type="text/javascript">alert("Booking full not updated!!!")</script>';
               }
    ...
    <form action="#" method="POST">
      <div class="form_wrap">
        ...
        <div class="input_wrap">
          ...
          <input type="tel" id="title" name="tel" placeholder="Tel"pattern="[0-9]{10}" required>
        </div>
